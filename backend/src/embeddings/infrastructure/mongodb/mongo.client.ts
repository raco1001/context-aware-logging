...
/**
 * MongoEmbeddingConnection - Separate MongoDB connection for the embeddings module.
 * Emphasizes that this module can operate as an independent service.
 */
@Injectable()
export class MongoEmbeddingConnection implements OnModuleInit, OnModuleDestroy {
  private readonly logger = new Logger(MongoEmbeddingConnection.name);
